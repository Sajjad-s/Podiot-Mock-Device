...
public class PowerSwitch implements Actuator{
    String deviceId;
    String clientId;
    ...
    public PowerSwitch(String deviceId, String clientId) {
        this.deviceId = deviceId;
        this.clientId = clientId;
    }

    @Override
    public void processInput(MqttClient client, String reportedTopic, UpdateDeviceTwinDto updateDeviceTwinDtoInput) throws JsonProcessException, MqttException, LineUnavailableException {
